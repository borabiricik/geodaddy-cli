# Technology Stack Research: geodaddy

**Project:** geodaddy - GEO/SEO Analysis CLI Tool
**Researched:** 2026-03-23
**Domain:** Website analysis, web crawling, performance metrics collection

## Executive Summary

The Rust ecosystem in 2026 provides mature, production-ready libraries for building high-performance CLI tools. For geodaddy's requirements (web crawling, headless browsing, JSON output, performance metrics), the recommended stack leverages:
...
All recommendations are based on 2026 ecosystem maturity, active maintenance, and verified version information.
...
**Confidence:** HIGH (Context7 + Official docs + 2026 benchmarks)
...
**Confidence:** HIGH (Official GitHub, verified usage stats)
...
**When to Use:** Essential for site-wide crawling to respect server resources and avoid rate limiting/bans.

**Confidence:** MEDIUM (WebSearch verified with community patterns)
...
**Confidence:** HIGH (Official GitHub, verified version, Servo lineage)
...
**Confidence:** HIGH (Official GitHub, verified benchmarks, version confirmed)
...
**Confidence:** HIGH (Official GitHub, verified comparison analysis)
...
**Recommendation:** Use chromiumoxide for async integration + comprehensive protocol access. If synchronous is acceptable, rust-headless-chrome has better DX but missing features.
...
**Best Practice (2026):**
Use **derive API** (not builder pattern) for cleaner code:
```rust
#[derive(Parser)]
...
**Why Not Structopt:**
Structopt is in maintenance mode. Clap v3+ integrated structopt directly. Use clap with derive macros instead.

**Confidence:** HIGH (Official docs, 2026 best practices verified)
...
**Confidence:** HIGH (Official releases, verified version)
...
**Confidence:** HIGH (Official GitHub, standards compliance)
...
**Confidence:** HIGH (Official GitHub, Google algorithm parity)
...
**Confidence:** HIGH (Official crate, verified version)
...
**Confidence:** HIGH (2026 community consensus, multiple sources)

**thiserror (for libraries):**
```toml
thiserror = "1.0"  # Use for internal library crates
```
...
**Confidence:** HIGH (Official docs, 2026 ecosystem standard)
...
**Recommended:** Rust 1.83+ (required by jsonschema)
...
**Decision:** Target Rust 1.83+ to accommodate jsonschema. This is reasonable for a 2026 greenfield project.
...
mockito = "1.6"           # HTTP mocking for tests
...
For developers familiar with other ecosystems:
